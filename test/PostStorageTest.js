...
describe("PostStorage", function () {
    ...
    it("should allow users to post and emit an event", async function () {
        ...
        await expect(postStorage.post(title1, content1, category1, tags, addr1.address))
    ...
    it("should allow a different caller to post on behalf of another user", async function () {
        ...
        await postStorage.connect(addr1).post(title2, content2, category2, tags, addr2.address);
    ...
    it("should retrieve posts by user address", async function () {
        ...
        await postStorage.post(title1, content1, category1, tags, addr1.address);
        await postStorage.post(title2, content2, category2, tags, addr1.address);
    ...
    it("should retrieve post by index", async function () {
        ...
        await postStorage.post(title3, content3, category3, tags, addr1.address);
    ...
    it("should retrieve all posts", async function () {
        ...
        await postStorage.post(title1, content1, category1, tags, addr1.address);
        await postStorage.post(title2, content2, category2, tags, addr1.address);
        await postStorage.post("Another Post", "Content", 2, ["tag3"], addr2.address);
    ...
    it("should retrieve all users", async function () {
        await postStorage.post("Post 1", "Content 1", 0, ["tag1"], addr1.address);
        await postStorage.post("Post 2", "Content 2", 1, ["tag2"], addr2.address);
    ...
    it("should revert when pagination is out of range", async function () {
        await postStorage.post(title1, content1, category1, ["tag1"], addr1.address);
